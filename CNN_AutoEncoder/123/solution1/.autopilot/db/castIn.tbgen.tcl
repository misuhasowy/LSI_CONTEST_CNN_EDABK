...
set C_modelArgList {
	...
	{ full_in_float14 int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "full_in_AXI_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "full_in_float14", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ full_in_float14_din sc_out sc_lv 32 signal 7 } 
	{ full_in_float14_num_data_valid sc_in sc_lv 2 signal 7 } 
	{ full_in_float14_fifo_cap sc_in sc_lv 2 signal 7 } 
	{ full_in_float14_full_n sc_in sc_logic 1 signal 7 } 
	{ full_in_float14_write sc_out sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "full_in_float14_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "full_in_float14", "role": "din" }} , 
 	{ "name": "full_in_float14_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "full_in_float14", "role": "num_data_valid" }} , 
 	{ "name": "full_in_float14_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "full_in_float14", "role": "fifo_cap" }} , 
 	{ "name": "full_in_float14_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_in_float14", "role": "full_n" }} , 
 	{ "name": "full_in_float14_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_in_float14", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"Port" : [
			...
			{"Name" : "full_in_float14", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	castIn {
		...
		full_in_float14 {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	full_in_float14 { ap_fifo {  { full_in_float14_din fifo_port_we 1 32 }  { full_in_float14_num_data_valid fifo_status_num_data_valid 0 2 }  { full_in_float14_fifo_cap fifo_update 0 2 }  { full_in_float14_full_n fifo_status 0 1 }  { full_in_float14_write fifo_data 1 1 } } }
}
