...
architecture behav of AutoEncoder_conv6 is 
...
attribute shreg_extract : string;
    ...
    signal conv6_Loop_CHeight_proc25_U0_ap_start : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_ap_done : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_ap_continue : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_ap_idle : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_ap_ready : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_upsamp5_out25_read : STD_LOGIC;
    signal conv6_Loop_CHeight_proc25_U0_conv6_out26_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv6_Loop_CHeight_proc25_U0_conv6_out26_write : STD_LOGIC;
    signal ap_sync_ready : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component AutoEncoder_conv6_Loop_CHeight_proc25 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    conv6_Loop_CHeight_proc25_U0 : component AutoEncoder_conv6_Loop_CHeight_proc25
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_idle <= conv6_Loop_CHeight_proc25_U0_ap_idle;
    ap_ready <= conv6_Loop_CHeight_proc25_U0_ap_ready;
    ap_sync_ready <= conv6_Loop_CHeight_proc25_U0_ap_ready;
    conv6_Loop_CHeight_proc25_U0_ap_continue <= ap_continue;
    conv6_Loop_CHeight_proc25_U0_ap_start <= real_start;
    conv6_out26_din <= conv6_Loop_CHeight_proc25_U0_conv6_out26_din;
    conv6_out26_write <= conv6_Loop_CHeight_proc25_U0_conv6_out26_write;
