...
set Library     "hls"
set IPName      "AutoEncoder"
set Version     "1.0"
set DisplayName "Autoencoder"
set Revision    "2113447791"
...
set xo_kernel_name "AutoEncoder"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/edabk/Downloads/son/LSI_CONTEST_CNN_EDABK/auto/CNN_AutoEncoder/123/solution1"
set debug_dir "/home/edabk/Downloads/son/LSI_CONTEST_CNN_EDABK/auto/CNN_AutoEncoder/123/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {AutoEncoder_regslice_both
...
AutoEncoder_regslice_both
AutoEncoder_regslice_both
AutoEncoder_flow_control_loop_pipe
...
AutoEncoder_mul_32s_14ns_46_1_1
AutoEncoder_flow_control_loop_pipe
AutoEncoder_flow_control_loop_pipe
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "full_in_AXI full_out_AXI"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 14507 II x}
