set moduleName conv1_Loop_CHeight_proc20
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {conv1_Loop_CHeight_proc20}
...
set portList { 
	...
	{ full_in_float14_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ full_in_float14_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ conv1_out16_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ conv1_out16_fifo_cap sc_in sc_lv 2 signal 1 } 
...
set Spec2ImplPortList { 
	full_in_float14 { ap_fifo {  { full_in_float14_dout fifo_port_we 0 32 }  { full_in_float14_num_data_valid fifo_status_num_data_valid 0 2 }  { full_in_float14_fifo_cap fifo_update 0 2 }  { full_in_float14_empty_n fifo_status 0 1 }  { full_in_float14_read fifo_data 1 1 } } }
	conv1_out16 { ap_fifo {  { conv1_out16_din fifo_port_we 1 32 }  { conv1_out16_num_data_valid fifo_status_num_data_valid 0 2 }  { conv1_out16_fifo_cap fifo_update 0 2 }  { conv1_out16_full_n fifo_status 0 1 }  { conv1_out16_write fifo_data 1 1 } } }
}
