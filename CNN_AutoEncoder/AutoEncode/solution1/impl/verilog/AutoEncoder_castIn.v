...
module AutoEncoder_castIn (
        ...
        full_in_float14_full_n,
        full_in_float14_write,
        start_out,
        start_write,
        full_in_AXI_TDATA,
        full_in_AXI_TREADY,
...
output  [31:0] full_in_float14_din;
input  [1:0] full_in_float14_num_data_valid;
input  [1:0] full_in_float14_fifo_cap;
input   full_in_float14_full_n;
output   full_in_float14_write;
output   start_out;
output   start_write;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0) & (icmp_ln11_fu_91_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        full_in_float14_write = 1'b1;
    end else begin
        full_in_float14_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((full_in_float14_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_91_p2 == 1'd0) & (full_in_AXI_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((full_in_float14_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_91_p2 == 1'd0) & (full_in_AXI_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((full_in_float14_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_91_p2 == 1'd0) & (full_in_AXI_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_91_p2 == 1'd0) & (full_in_AXI_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (full_in_float14_full_n == 1'b0);
end
...
assign full_in_float14_din = tmp_data_V_reg_122;

assign i_4_fu_97_p2 = (ap_sig_allocacmp_i_3 + 10'd1);

assign icmp_ln11_fu_91_p2 = ((ap_sig_allocacmp_i_3 == 10'd784) ? 1'b1 : 1'b0);

assign start_out = real_start;

endmodule //AutoEncoder_castIn
