...
architecture behav of encode_castOut is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln26_fu_114_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_2_fu_120_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    regslice_both_full_out_AXI_V_data_V_U : component encode_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_keep_V_U : component encode_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_strb_V_U : component encode_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_user_V_U : component encode_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_last_V_U : component encode_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_id_V_U : component encode_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_out_AXI_V_dest_V_U : component encode_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_110)) then
                if ((icmp_ln26_fu_114_p2 = ap_const_lv1_0)) then 
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_done_reg, full_out_float16_empty_n, regslice_both_full_out_AXI_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter1_reg, ap_start_int, full_out_AXI_TREADY_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_loop_exit_ready_pp0_iter1_reg = ap_const_logic_1) and (regslice_both_full_out_AXI_V_data_V_U_apdone_blk = ap_const_logic_1)) or ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (full_out_AXI_TREADY_int_regslice = ap_const_logic_0)) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((regslice_both_full_out_AXI_V_data_V_U_apdone_blk = ap_const_logic_1) or (full_out_float16_empty_n = ap_const_logic_0) or (full_out_AXI_TREADY_int_regslice = ap_const_logic_0))) or ((ap_done_reg = ap_const_logic_1) and (ap_start_int = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_done_reg, full_out_float16_empty_n, regslice_both_full_out_AXI_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter1_reg, ap_start_int, full_out_AXI_TREADY_int_regslice)
    begin
    ...
    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, ap_done_reg, full_out_float16_empty_n, regslice_both_full_out_AXI_V_data_V_U_apdone_blk, ap_loop_exit_ready_pp0_iter1_reg, ap_start_int, full_out_AXI_TREADY_int_regslice)
    begin
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(full_out_float16_empty_n, regslice_both_full_out_AXI_V_data_V_U_apdone_blk, full_out_AXI_TREADY_int_regslice)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((regslice_both_full_out_AXI_V_data_V_U_apdone_blk = ap_const_logic_1) or (full_out_float16_empty_n = ap_const_logic_0) or (full_out_AXI_TREADY_int_regslice = ap_const_logic_0));
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_subdone, icmp_ln26_fu_114_p2, ap_start_int)
    begin
        if (((icmp_ln26_fu_114_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    full_out_float16_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, full_out_float16_empty_n, ap_block_pp0_stage0)
    begin
    ...
    full_out_float16_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            full_out_float16_read <= ap_const_logic_1;
        else 
            full_out_float16_read <= ap_const_logic_0;
        end if; 
    end process;

    i_2_fu_120_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv8_1));
    icmp_ln26_fu_114_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv8_80) else "0";
end behav;
