...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "encode.autotvin.dat"
	set constFileTvOut       "encode.autotvout.dat"
	set constFileHdlTvIn     "encode.autohdltvin.dat"
	set constFileHdlTvOut    "encode.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
