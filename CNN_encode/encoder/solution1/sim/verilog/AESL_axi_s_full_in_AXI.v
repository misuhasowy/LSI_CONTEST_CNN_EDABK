...
module AESL_axi_s_full_in_AXI (
    ...
    fifo #(784, 32) fifo_full_in_AXI_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_full_in_AXI_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_full_in_AXI_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 2) fifo_full_in_AXI_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 1) fifo_full_in_AXI_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 5) fifo_full_in_AXI_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 6) fifo_full_in_AXI_TDEST (
        .reset(1'b0),
        .write_clock(clk),
