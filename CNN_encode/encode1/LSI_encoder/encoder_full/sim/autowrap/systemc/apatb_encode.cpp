...
#define WRAPC_STREAM_SIZE_IN_full_in "../tv/stream_size/stream_size_in_full_in.dat"
#define WRAPC_STREAM_INGRESS_STATUS_full_in "../tv/stream_size/stream_ingress_status_full_in.dat"
#define AUTOTB_TVOUT_full_out "../tv/cdatafile/c.encode.autotvout_full_out.dat"
#define WRAPC_STREAM_SIZE_OUT_full_out "../tv/stream_size/stream_size_out_full_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_full_out "../tv/stream_size/stream_egress_status_full_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_full_out "../tv/rtldatafile/rtl.encode.autotvout_full_out.dat"
...
extern "C"
void encode_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_encode_hw(void* __xlx_apatb_param_full_in, void* __xlx_apatb_param_full_out)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 40,
    .name = "full_in",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_full_in),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_full_in),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_full_in),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_full_in),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_full_in;
  ...
  static hls::sim::Stream<hls::sim::Byte<8>> port1 {
    ...
    .name = "full_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_full_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_full_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_full_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_full_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_full_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    encode_hw_stub_wrapper(__xlx_apatb_param_full_in, __xlx_apatb_param_full_out);
    port1.buffer();
