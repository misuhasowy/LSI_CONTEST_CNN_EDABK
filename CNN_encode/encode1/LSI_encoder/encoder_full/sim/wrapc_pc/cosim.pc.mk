...
$(ObjDir)/encode_test.cpp_pre.cpp.tb.o : encode_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling encode_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/encode.cpp_pre.cpp.tb.o : encode.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling encode.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
