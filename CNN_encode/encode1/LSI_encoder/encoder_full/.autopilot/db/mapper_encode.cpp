...
unsigned int ap_apatb_full_in_cap_bc;
static AESL_RUNTIME_BC __xlx_full_in_V_size_Reader("../tv/stream_size/stream_size_in_full_in.dat");
unsigned int ap_apatb_full_out_cap_bc;
static AESL_RUNTIME_BC __xlx_full_out_V_size_Reader("../tv/stream_size/stream_size_out_full_out.dat");
using hls::sim::Byte;
extern "C" void encode(long long*, long long*);
extern "C" void apatb_encode_hw(volatile void * __xlx_apatb_param_full_in, volatile void * __xlx_apatb_param_full_out) {
using hls::sim::createStream;
auto* sfull_in = createStream((hls::stream<long long>*)__xlx_apatb_param_full_in);
  //Create input buffer for full_out
  ap_apatb_full_out_cap_bc = __xlx_full_out_V_size_Reader.read_size();
  long long* __xlx_full_out_input_buffer= new long long[ap_apatb_full_out_cap_bc];
auto* sfull_out = createStream((hls::stream<long long>*)__xlx_apatb_param_full_out);
  // DUT call
  encode(sfull_in->data<long long>(), sfull_out->data<long long>());
sfull_in->transfer((hls::stream<long long>*)__xlx_apatb_param_full_in);
sfull_out->transfer((hls::stream<long long>*)__xlx_apatb_param_full_out);
}
