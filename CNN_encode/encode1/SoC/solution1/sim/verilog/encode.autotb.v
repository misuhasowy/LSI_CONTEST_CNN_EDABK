...
`define AUTOTB_DUT      encode
`define AUTOTB_DUT_INST AESL_inst_encode
`define AUTOTB_TOP      apatb_encode_top
`define AUTOTB_LAT_RESULT_FILE "encode.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "encode.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_encode_top
...
`define AUTOTB_TVIN_full_in_AXI_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_data_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_keep_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_strb_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_user_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_last_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_id_V.dat"
`define AUTOTB_TVIN_full_in_AXI_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvin_full_in_AXI_V_dest_V.dat"
...
`define AUTOTB_TVOUT_full_out_AXI_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_data_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_keep_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_strb_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_user_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_last_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_id_V.dat"
`define AUTOTB_TVOUT_full_out_AXI_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.encode.autotvout_full_out_AXI_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 14404;
parameter LENGTH_full_in_AXI_V_data_V = 784;
parameter LENGTH_full_in_AXI_V_keep_V = 784;
parameter LENGTH_full_in_AXI_V_strb_V = 784;
parameter LENGTH_full_in_AXI_V_user_V = 784;
parameter LENGTH_full_in_AXI_V_last_V = 784;
parameter LENGTH_full_in_AXI_V_id_V = 784;
parameter LENGTH_full_in_AXI_V_dest_V = 784;
parameter LENGTH_full_out_AXI_V_data_V = 128;
parameter LENGTH_full_out_AXI_V_keep_V = 128;
parameter LENGTH_full_out_AXI_V_strb_V = 128;
parameter LENGTH_full_out_AXI_V_user_V = 128;
parameter LENGTH_full_out_AXI_V_last_V = 128;
parameter LENGTH_full_out_AXI_V_id_V = 128;
parameter LENGTH_full_out_AXI_V_dest_V = 128;
