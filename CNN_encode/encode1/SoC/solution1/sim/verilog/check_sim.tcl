...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.encode.autotvin_full_in_AXI_V_data_V.dat"
         "c.encode.autotvin_full_in_AXI_V_keep_V.dat"
         "c.encode.autotvin_full_in_AXI_V_strb_V.dat"
         "c.encode.autotvin_full_in_AXI_V_user_V.dat"
         "c.encode.autotvin_full_in_AXI_V_last_V.dat"
         "c.encode.autotvin_full_in_AXI_V_id_V.dat"
         "c.encode.autotvin_full_in_AXI_V_dest_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.encode.autotvout_full_out_AXI_V_data_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_keep_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_strb_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_user_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_last_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_id_V.dat"
         "rtl.encode.autotvout_full_out_AXI_V_dest_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
