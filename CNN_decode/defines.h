...
#define CONV2_HEIGHT (CONV1_HEIGHT/2)
#define CONV2_WIDTH (CONV1_WIDTH/2)
#define CONV3_HEIGHT (CONV2_HEIGHT/2)
#define CONV3_WIDTH (CONV2_WIDTH/2)
#define CONV4_HEIGHT 4
#define CONV4_WIDTH 4
#define CONV5_HEIGHT (CONV4_HEIGHT*2)
#define CONV5_WIDTH (CONV4_WIDTH*2)
#define CONV6_HEIGHT (CONV5_HEIGHT*2-2)
#define CONV6_WIDTH (CONV5_WIDTH*2-2)
#define CONV7_HEIGHT (CONV6_HEIGHT*2)
#define CONV7_WIDTH (CONV6_WIDTH*2)
...
#define UPSAM4_HEIGHT (POOL3_HEIGHT*2)
#define UPSAM4_WIDTH (POOL3_WIDTH*2)
#define UPSAM5_HEIGHT (UPSAM4_HEIGHT*2)
#define UPSAM5_WIDTH (UPSAM4_WIDTH*2)
#define UPSAM6_HEIGHT ((UPSAM5_HEIGHT-2)*2)
#define UPSAM6_WIDTH ((UPSAM5_WIDTH-2)*2)
