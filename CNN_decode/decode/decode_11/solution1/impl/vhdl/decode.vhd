...
architecture behav of decode is 
    ...
    signal castIn_U0_full_in_float8_din : STD_LOGIC_VECTOR (31 downto 0);
    signal castIn_U0_full_in_float8_write : STD_LOGIC;
    ...
    signal conv4_U0_full_in_float8_read : STD_LOGIC;
    signal conv4_U0_conv4_out10_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv4_U0_conv4_out10_write : STD_LOGIC;
    ...
    signal upsamp4_U0_conv4_out10_read : STD_LOGIC;
    signal upsamp4_U0_upsamp4_out11_din : STD_LOGIC_VECTOR (31 downto 0);
    signal upsamp4_U0_upsamp4_out11_write : STD_LOGIC;
    ...
    signal conv5_U0_upsamp4_out11_read : STD_LOGIC;
    signal conv5_U0_conv5_out12_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv5_U0_conv5_out12_write : STD_LOGIC;
    ...
    signal upsamp5_U0_conv5_out12_read : STD_LOGIC;
    signal upsamp5_U0_upsamp5_out13_din : STD_LOGIC_VECTOR (31 downto 0);
    signal upsamp5_U0_upsamp5_out13_write : STD_LOGIC;
    ...
    signal conv6_U0_upsamp5_out13_read : STD_LOGIC;
    signal conv6_U0_conv6_out14_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv6_U0_conv6_out14_write : STD_LOGIC;
    ...
    signal upsamp6_U0_conv6_out14_read : STD_LOGIC;
    signal upsamp6_U0_upsamp6_out15_din : STD_LOGIC_VECTOR (31 downto 0);
    signal upsamp6_U0_upsamp6_out15_write : STD_LOGIC;
    ...
    signal conv7_U0_upsamp6_out15_read : STD_LOGIC;
    signal conv7_U0_start_out : STD_LOGIC;
    signal conv7_U0_start_write : STD_LOGIC;
    signal conv7_U0_full_out_float9_din : STD_LOGIC_VECTOR (31 downto 0);
    signal conv7_U0_full_out_float9_write : STD_LOGIC;
    ...
    signal castOut_U0_full_out_float9_read : STD_LOGIC;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        upsamp5_out13_dout : IN STD_LOGIC_VECTOR (31 downto 0);
        upsamp5_out13_num_data_valid : IN STD_LOGIC_VECTOR (1 downto 0);
        upsamp5_out13_fifo_cap : IN STD_LOGIC_VECTOR (1 downto 0);
        upsamp5_out13_empty_n : IN STD_LOGIC;
        upsamp5_out13_read : OUT STD_LOGIC;
        conv6_out14_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        conv6_out14_num_data_valid : IN STD_LOGIC_VECTOR (1 downto 0);
        conv6_out14_fifo_cap : IN STD_LOGIC_VECTOR (1 downto 0);
        conv6_out14_full_n : IN STD_LOGIC;
        conv6_out14_write : OUT STD_LOGIC;
        start_out : OUT STD_LOGIC;
        start_write : OUT STD_LOGIC );
    end component;
    ...
    component decode_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component decode_start_for_conv4_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component decode_start_for_castOut_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    castIn_U0 : component decode_castIn
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    castOut_U0 : component decode_castOut
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    full_in_float_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    conv4_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    upsamp4_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    conv5_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    upsamp5_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    conv6_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    upsamp6_out_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    full_out_float_U : component decode_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_conv4_U0_U : component decode_start_for_conv4_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_castOut_U0_U : component decode_start_for_castOut_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= castOut_U0_ap_done;
    ap_idle <= (upsamp6_U0_ap_idle and upsamp5_U0_ap_idle and upsamp4_U0_ap_idle and conv7_U0_ap_idle and conv6_U0_ap_idle and conv5_U0_ap_idle and conv4_U0_ap_idle and castOut_U0_ap_idle and castIn_U0_ap_idle);
    ap_ready <= castIn_U0_ap_ready;
