...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decode.autotvin.dat"
	set constFileTvOut       "decode.autotvout.dat"
	set constFileHdlTvIn     "decode.autohdltvin.dat"
	set constFileHdlTvOut    "decode.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
