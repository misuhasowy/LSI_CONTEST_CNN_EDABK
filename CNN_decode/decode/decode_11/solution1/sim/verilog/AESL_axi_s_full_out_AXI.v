...
`define TV_OUT_full_out_AXI_TDATA "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_data_V.dat"
`define EGRESS_STATUS_full_out_AXI_TDATA "../tv/stream_size/stream_egress_status_full_out_AXI_V_data_V.dat"
`define TV_OUT_full_out_AXI_TKEEP "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_keep_V.dat"
`define EGRESS_STATUS_full_out_AXI_TKEEP "../tv/stream_size/stream_egress_status_full_out_AXI_V_keep_V.dat"
`define TV_OUT_full_out_AXI_TSTRB "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_strb_V.dat"
`define EGRESS_STATUS_full_out_AXI_TSTRB "../tv/stream_size/stream_egress_status_full_out_AXI_V_strb_V.dat"
`define TV_OUT_full_out_AXI_TUSER "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_user_V.dat"
`define EGRESS_STATUS_full_out_AXI_TUSER "../tv/stream_size/stream_egress_status_full_out_AXI_V_user_V.dat"
`define TV_OUT_full_out_AXI_TLAST "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_last_V.dat"
`define EGRESS_STATUS_full_out_AXI_TLAST "../tv/stream_size/stream_egress_status_full_out_AXI_V_last_V.dat"
`define TV_OUT_full_out_AXI_TID "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_id_V.dat"
`define EGRESS_STATUS_full_out_AXI_TID "../tv/stream_size/stream_egress_status_full_out_AXI_V_id_V.dat"
`define TV_OUT_full_out_AXI_TDEST "../tv/rtldatafile/rtl.decode.autotvout_full_out_AXI_V_dest_V.dat"
...
module AESL_axi_s_full_out_AXI (
    ...
    fifo #(784, 32) fifo_full_out_AXI_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_full_out_AXI_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_full_out_AXI_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 2) fifo_full_out_AXI_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 1) fifo_full_out_AXI_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 5) fifo_full_out_AXI_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 6) fifo_full_out_AXI_TDEST (
        .reset(1'b0),
        .write_clock(clk),
