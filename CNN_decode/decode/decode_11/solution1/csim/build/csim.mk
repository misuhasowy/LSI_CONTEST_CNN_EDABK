...
HLS_SOURCES = ../../../../decode_test.cpp ../../../../decode.cpp
...
$(ObjDir)/decode_test.o: ../../../../decode_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../decode_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/decode_test.d
