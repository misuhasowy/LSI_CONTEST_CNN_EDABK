...
// tvout file define:
#define AUTOTB_TVOUT_PC_full_out "../tv/rtldatafile/rtl.decode.autotvout_full_out.dat"
...
extern "C"
void decode_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_decode_hw(void* __xlx_apatb_param_full_in, void* __xlx_apatb_param_full_out)
{
  ...
  try {
    ...
    decode_hw_stub_wrapper(__xlx_apatb_param_full_in, __xlx_apatb_param_full_out);
    port1.buffer();
