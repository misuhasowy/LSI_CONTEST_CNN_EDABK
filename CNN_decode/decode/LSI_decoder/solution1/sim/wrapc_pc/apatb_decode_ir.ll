; ModuleID = 'C:/Users/ADMIN/GithubClonedRepo/decode/LSI_decoder/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_decode_ir(%"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull dereferenceable(8) %full_in, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull dereferenceable(8) %full_out) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_decode_hw(i40* %full_in_copy, i40* %full_out_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.58"(i40* align 512 %1, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.58"(i40* align 512 %3, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* %2)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.52"(%"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %dst, i40* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.52"(%"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="0", i40* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #5 {
entry:
  %2 = alloca i40
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.58"(i40* noalias nocapture align 512 "unpacked"="0.0" %dst, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* noalias "unpacked"="1" %src) unnamed_addr #4 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.61"(i40* align 512 %dst, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>.61"(i40* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #5 {
entry:
...
declare void @apatb_decode_hw(i40*, i40*)
...
define void @decode_hw_stub_wrapper(i40*, i40*) #6 {
entry:
  %2 = alloca %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"
  %3 = alloca %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"
  ...
  call void @decode_hw_stub(%"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* %2, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"* %3)
...
declare void @decode_hw_stub(%"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"*, %"class.hls::stream<ap_fixed<40, 10, AP_TRN, AP_WRAP, 0>, 0>"*)
