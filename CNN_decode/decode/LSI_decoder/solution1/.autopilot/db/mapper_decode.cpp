...
using hls::sim::Byte;
extern "C" void decode(long long*, long long*);
extern "C" void apatb_decode_hw(volatile void * __xlx_apatb_param_full_in, volatile void * __xlx_apatb_param_full_out) {
...
auto* sfull_out = createStream((hls::stream<long long>*)__xlx_apatb_param_full_out);
  // DUT call
  decode(sfull_in->data<long long>(), sfull_out->data<long long>());
