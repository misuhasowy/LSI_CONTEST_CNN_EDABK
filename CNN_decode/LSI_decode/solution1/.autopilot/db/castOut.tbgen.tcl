...
set C_modelArgList {
	{ full_out_float9 int 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "full_out_float9", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ full_out_float9_dout sc_in sc_lv 32 signal 0 } 
	{ full_out_float9_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ full_out_float9_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ full_out_float9_empty_n sc_in sc_logic 1 signal 0 } 
	{ full_out_float9_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "full_out_float9_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "full_out_float9", "role": "dout" }} , 
 	...
 	{ "name": "full_out_float9_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_out_float9", "role": "empty_n" }} , 
 	{ "name": "full_out_float9_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_out_float9", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "full_out_float9", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	full_out_float9 { ap_fifo {  { full_out_float9_dout fifo_port_we 0 32 }  { full_out_float9_num_data_valid fifo_status_num_data_valid 0 2 }  { full_out_float9_fifo_cap fifo_update 0 2 }  { full_out_float9_empty_n fifo_status 0 1 }  { full_out_float9_read fifo_data 1 1 } } }
