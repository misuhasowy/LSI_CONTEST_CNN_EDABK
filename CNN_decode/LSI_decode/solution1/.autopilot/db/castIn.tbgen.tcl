...
set C_modelArgList {
	...
	{ full_in_float8 int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "full_in_AXI_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "full_in_float8", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ full_in_float8_din sc_out sc_lv 32 signal 7 } 
	{ full_in_float8_num_data_valid sc_in sc_lv 2 signal 7 } 
	{ full_in_float8_fifo_cap sc_in sc_lv 2 signal 7 } 
	{ full_in_float8_full_n sc_in sc_logic 1 signal 7 } 
	{ full_in_float8_write sc_out sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "full_in_float8_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "full_in_float8", "role": "din" }} , 
 	{ "name": "full_in_float8_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "full_in_float8", "role": "num_data_valid" }} , 
 	{ "name": "full_in_float8_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "full_in_float8", "role": "fifo_cap" }} , 
 	{ "name": "full_in_float8_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_in_float8", "role": "full_n" }} , 
 	{ "name": "full_in_float8_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "full_in_float8", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"Port" : [
			...
			{"Name" : "full_in_float8", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_data_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_keep_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_strb_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_user_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_last_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_id_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_full_in_AXI_V_dest_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	full_in_AXI_V_dest_V { axis {  { full_in_AXI_TVALID in_vld 0 1 }  { full_in_AXI_TREADY in_acc 1 1 }  { full_in_AXI_TDEST in_data 0 6 } } }
	full_in_float8 { ap_fifo {  { full_in_float8_din fifo_port_we 1 32 }  { full_in_float8_num_data_valid fifo_status_num_data_valid 0 2 }  { full_in_float8_fifo_cap fifo_update 0 2 }  { full_in_float8_full_n fifo_status 0 1 }  { full_in_float8_write fifo_data 1 1 } } }
}
