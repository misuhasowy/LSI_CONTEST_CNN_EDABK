...
port (
    ...
    full_in_float8_din : OUT STD_LOGIC_VECTOR (31 downto 0);
    full_in_float8_num_data_valid : IN STD_LOGIC_VECTOR (1 downto 0);
    full_in_float8_fifo_cap : IN STD_LOGIC_VECTOR (1 downto 0);
    full_in_float8_full_n : IN STD_LOGIC;
    full_in_float8_write : OUT STD_LOGIC;
...
architecture behav of decode_castIn is 
...
attribute shreg_extract : string;
    ...
    signal i_4_fu_97_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    regslice_both_full_in_AXI_V_data_V_U : component decode_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_keep_V_U : component decode_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_strb_V_U : component decode_regslice_both
    generic map (
        DataWidth => 4)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_user_V_U : component decode_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_last_V_U : component decode_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_id_V_U : component decode_regslice_both
    generic map (
        DataWidth => 5)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_full_in_AXI_V_dest_V_U : component decode_regslice_both
    generic map (
        DataWidth => 6)
    port map (
        ap_clk => ap_clk,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_115)) then
                if ((icmp_ln8_fu_91_p2 = ap_const_lv1_0)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln8_fu_91_p2, ap_done_reg, full_in_float8_full_n, ap_start_int, full_in_AXI_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((full_in_float8_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (full_in_AXI_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln8_fu_91_p2, ap_done_reg, full_in_float8_full_n, ap_start_int, full_in_AXI_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((full_in_float8_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (full_in_AXI_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, icmp_ln8_fu_91_p2, ap_done_reg, full_in_float8_full_n, ap_start_int, full_in_AXI_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((full_in_float8_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (full_in_AXI_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(icmp_ln8_fu_91_p2, ap_done_reg, full_in_AXI_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (full_in_AXI_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(full_in_float8_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (full_in_float8_full_n = ap_const_logic_0);
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln8_fu_91_p2, ap_block_pp0_stage0_subdone, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (icmp_ln8_fu_91_p2 = ap_const_lv1_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    full_in_AXI_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln8_fu_91_p2, ap_done_reg, ap_block_pp0_stage0, ap_start_int, full_in_AXI_TVALID_int_regslice)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_done_reg = ap_const_logic_0) and (icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    full_in_AXI_TREADY_int_regslice_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln8_fu_91_p2, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln8_fu_91_p2 = ap_const_lv1_0) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    full_in_float8_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, full_in_float8_full_n, ap_block_pp0_stage0)
    begin
    ...
    full_in_float8_din <= tmp_data_V_reg_122;

    full_in_float8_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            full_in_float8_write <= ap_const_logic_1;
        else 
            full_in_float8_write <= ap_const_logic_0;
        end if; 
    end process;

    i_4_fu_97_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_3) + unsigned(ap_const_lv8_1));
    icmp_ln8_fu_91_p2 <= "1" when (ap_sig_allocacmp_i_3 = ap_const_lv8_80) else "0";
