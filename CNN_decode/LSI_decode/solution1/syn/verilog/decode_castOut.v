...
module decode_castOut (
        ...
        ap_idle,
        ap_ready,
        full_out_float9_dout,
        full_out_float9_num_data_valid,
        full_out_float9_fifo_cap,
        full_out_float9_empty_n,
        full_out_float9_read,
        full_out_AXI_TREADY,
        full_out_AXI_TDATA,
        full_out_AXI_TVALID,
        full_out_AXI_TKEEP,
...
output   ap_idle;
output   ap_ready;
input  [31:0] full_out_float9_dout;
input  [1:0] full_out_float9_num_data_valid;
input  [1:0] full_out_float9_fifo_cap;
input   full_out_float9_empty_n;
output   full_out_float9_read;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_110)) begin
        if ((icmp_ln23_fu_114_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_114_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        full_out_float9_read = 1'b1;
    end else begin
        full_out_float9_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((regslice_both_full_out_AXI_V_data_V_U_apdone_blk == 1'b1) | (full_out_float9_empty_n == 1'b0) | (full_out_AXI_TREADY_int_regslice == 1'b0));
end
...
assign icmp_ln23_fu_114_p2 = ((ap_sig_allocacmp_i_1 == 10'd784) ? 1'b1 : 1'b0);

endmodule //decode_castOut
